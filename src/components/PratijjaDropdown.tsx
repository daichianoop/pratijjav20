...
const PratijjaDropdown = () => {
	return (
		<div className="transition-all duration-400 absolute px-2 text-center bg-black rounded-lg left-1/2 translate-x-[-50%] py-1 mt-4 text-white hidden group-hover:block ease-in-out min-w-min">

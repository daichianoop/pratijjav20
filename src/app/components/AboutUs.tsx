...
const barlow = Barlow({
	weight: "900", // specify desired weight (if available)
	subsets: ["latin"], // specify the needed subsets
});
			...
			<div className="bg-[#002027]">
				<section className="relative bg-[#002027]">
					...
					<div className="container mx-auto py-16 px-4 relative text-center">
						...
						<p className="text-lg text-teal-950 max-w-3xl mt-4 text-center mx-auto">
				...
				<section className="relative container mx-auto px-4 py-16 ">
					...
					{/* "Since 2006" in Left with Image in Right */}
					<div className="grid grid-cols-2 gap-12 items-center relative mt-16 z-10">
						<div

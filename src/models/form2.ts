...
// Define the schema for institutional team registration
...
// If model exists, use that, else create a new model
const Form2Model = models.Form2 || model<Form2>("Form2", Form2Schema);
